...
beforeEach(async () => {
  ...
  try {
    ...
    await pool.query('TRUNCATE TABLE notifications, post_comments, post_likes, post_media, posts, checkins, dog_memberships, dogs, friendships, users RESTART IDENTITY CASCADE');
  } catch (error) {
